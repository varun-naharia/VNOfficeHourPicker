#
#  Be sure to run `pod spec lint VNOfficeHourPicker.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Varun Naharia" => "varun.naharia@gmail.com" }
  # Or just: s.author    = "Varun Naharia"
  # s.authors            = { "Varun Naharia" => "varun.naharia@gmail.com" }
  s.social_media_url   = "http://twitter.com/VNaharia"
  ...
  s.source       = { :git => "https://github.com/varun-naharia/VNOfficeHourPicker.git", :tag => "#{s.version}" }
